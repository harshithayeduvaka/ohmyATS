...
export const mockScanResult: ScanResult = {
  ...
  keywordAnalysis: [
    { keyword: "Business Development", foundInCV: true, importance: "critical", context: "Found in experience section" },
    { keyword: "CRM", foundInCV: false, importance: "critical", context: "Add HubSpot or Salesforce to Tools section" },
    { keyword: "Market Research", foundInCV: true, importance: "high", context: "Mentioned but lacks quantifiable outcome" },
    { keyword: "Revenue Growth", foundInCV: false, importance: "critical", context: "Add revenue metrics to experience bullets" },
    { keyword: "International Markets", foundInCV: true, importance: "high", context: "Well-supported by SKEMA background" },
    { keyword: "Pipeline Management", foundInCV: false, importance: "high", context: "Add to demonstrate sales process knowledge" },
    { keyword: "Cross-cultural", foundInCV: true, importance: "medium", context: "Implied but could be more explicit" },
    { keyword: "Strategic Planning", foundInCV: false, importance: "high", context: "Add strategic context to experience bullets" },
    { keyword: "Stakeholder Management", foundInCV: true, importance: "medium", context: "Present in descriptions" },
    { keyword: "Data Analysis", foundInCV: false, importance: "medium", context: "Add analytical tools or methods used" },
  ],
};
